...
abstract class BaseDataLists implements ListsInterface
{
    ...
    protected bool $_validateParamsCheck = true;
    ...
    protected $startTime;
    protected $endTime;
    protected $startTimeGet;
    protected $endTimeGet;
    ...
    private function initSearch()
    {
        ...
        $this->startTimeGet = $startTime;
        $this->startTime = strtotime($startTime);
        $endTime = $this->request->get('end_time');
        $this->endTimeGet =  $endTime ;
